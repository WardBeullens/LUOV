...
*/
void f80addInPlace(f80FELT *a, f80FELT *b) {
...
f80FELT f80multiply(f80FELT a, f80FELT b) {
	...
	temp[0] = f16multiply(a.coef[0], b.coef[0]);
	temp[1] = f16multiply(a.coef[1], b.coef[0]) ^ f16multiply(a.coef[0], b.coef[1]);
	temp[2] = f16multiply(a.coef[2], b.coef[0]) ^ f16multiply(a.coef[1], b.coef[1]) ^ f16multiply(a.coef[0], b.coef[2]);
	temp[3] = f16multiply(a.coef[3], b.coef[0]) ^ f16multiply(a.coef[2], b.coef[1]) ^ f16multiply(a.coef[1], b.coef[2]) ^ f16multiply(a.coef[0], b.coef[3]);
	temp[4] = f16multiply(a.coef[4], b.coef[0]) ^ f16multiply(a.coef[3], b.coef[1]) ^ f16multiply(a.coef[2], b.coef[2]) ^ f16multiply(a.coef[1], b.coef[3]) ^ f16multiply(a.coef[0], b.coef[4]);
	temp[5] = f16multiply(a.coef[4], b.coef[1]) ^ f16multiply(a.coef[3], b.coef[2]) ^ f16multiply(a.coef[2], b.coef[3]) ^ f16multiply(a.coef[1], b.coef[4]);
	temp[6] = f16multiply(a.coef[4], b.coef[2]) ^ f16multiply(a.coef[3], b.coef[3]) ^ f16multiply(a.coef[2], b.coef[4]);
	temp[7] = f16multiply(a.coef[4], b.coef[3]) ^ f16multiply(a.coef[3], b.coef[4]);
	temp[8] = f16multiply(a.coef[4], b.coef[4]);
