...
#define PARTSIG_VINEGAR(partial_signature) (PARTSIG_INVERSE(partial_signature) + (OIL_VARS*sizeof(FELT)+7)/8*8*OIL_VARS*(FIELD_SIZE))
#define PARTSIG_TARGET(partial_signature) (PARTSIG_VINEGAR(partial_signature) + (sizeof(FELT))*VINEGAR_VARS )
#define PARTSIG_T(partial_signature) (PARTSIG_TARGET(partial_signature) + (sizeof(FELT))*OIL_VARS  )
