...
main()
{
    ...
    int                 count;
    int                 done;
    alignas(32) unsigned char       pk[CRYPTO_PUBLICKEYBYTES], sk[CRYPTO_SECRETKEYBYTES];
    int                 ret_val;
    ...
    do {
        ...
        m =  (unsigned char *)aligned_alloc(32,mlen*sizeof(unsigned char));
        m1 = (unsigned char *)aligned_alloc(32,(mlen+CRYPTO_BYTES)*sizeof(unsigned char));
        sm = (unsigned char *)aligned_alloc(32,(mlen+CRYPTO_BYTES)*sizeof(unsigned char));
